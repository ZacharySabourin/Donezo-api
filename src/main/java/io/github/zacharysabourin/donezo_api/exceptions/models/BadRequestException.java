...
/**
 * A custom exception for <code>400 Bad Request</code> responses. Created to fit
 * the RFC 9457 specification and hook into Srping's own error response
 * handling.
 */
public class BadRequestException extends ServletException implements ErrorResponse {

    private final HttpMethod httpMethod;
    private final ProblemDetail body;

    public BadRequestException(String message, HttpMethod httpMethod) {
        super(message);
